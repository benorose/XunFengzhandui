...
/* Private defines -----------------------------------------------------------*/
#define B_IN1_Pin GPIO_PIN_0
#define B_IN1_GPIO_Port GPIOA
#define B_IN2_Pin GPIO_PIN_1
#define B_IN2_GPIO_Port GPIOA
#define B_IN3_Pin GPIO_PIN_2
#define B_IN3_GPIO_Port GPIOA
#define B_IN4_Pin GPIO_PIN_3
...
#define F_IN3_Pin GPIO_PIN_8
#define F_IN3_GPIO_Port GPIOB
#define F_IN4_Pin GPIO_PIN_9
